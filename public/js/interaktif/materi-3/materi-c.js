...
/**
 * Memeriksa jawaban pada aktivitas analisis pose.
 */
function checkDebug(button, choice) {
    ...
    if (choice === correct) {
        ...
        feedback.innerHTML =
            "❌ Jawaban kurang tepat. Perhatikan kembali penyebab kesalahan model kecerdasan buatan berbasis pose tubuh.";
...
/**
 * Mengambil kode jawaban dari atribut onclick.
 */
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
         ...
         * hasil pengerjaan hanya dianggap latihan.
         */
        if (isCompleted) {
            event.preventDefault();
 ...
 */
function resetPoseDebugActivity() {
    totalBenar = 0;
    totalDijawab = 0;
